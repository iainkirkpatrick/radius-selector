...
L.Draw.SimpleShape = L.Draw.Feature.extend({
	...
	_onMouseDown: function (e) {
		...
		//hack to change the starting latlon to globally exposed geolocation
		this._startLatLng.lat = geolocation.latitude;
		this._startLatLng.lng = geolocation.longitude;
